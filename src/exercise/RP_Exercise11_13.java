...
class RP_Exercise11_13 {
	public static void main(String[] args) throws Exception {
		...
		RP1113_Player[] pArr = {
			new RP1113_Player("타짜", deck.pick(), deck.pick()),
			new RP1113_Player("고수", deck.pick(), deck.pick()),
			new RP1113_Player("물주", deck.pick(), deck.pick()),
			new RP1113_Player("중수", deck.pick(), deck.pick()),
			new RP1113_Player("하수", deck.pick(), deck.pick())
		};
